...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <button @click="highlightedAuthor = 'Jane Austen'">Highlight Jane Austen</button>
      <button @click="highlightedAuthor = 'Agatha Christie'">Highlight Agatha Christie</button>
      <button @click="highlightedAuthor = 'George Orwell'">Highlight George Orwell</button>
...
const flashingAuthor = ref(null)

onMounted(() => {
  setInterval(() => {
    flashingAuthor.value =
      flashingAuthor.value === "Agatha Christie" ? null : "Agatha Christie"
  }, 500)
})
